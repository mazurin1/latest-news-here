...
function getResults() {
    ...
    $.getJSON("/all", function(data) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        $("#results").prepend("<p class='row data-entry' data-id=" + data[i]._id + "><span class='col col-9 dataTitle' data-id=" +
          data[i]._id + ">" + data[i].title + "</span><span class='col col-3'><button class='btn btn-dark ml-4 save'>Save</button><button class='btn btn-secondary ml-1 delete'>Delete</button></span></p>");
      }
    });
  }
